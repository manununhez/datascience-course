...
becal_completo = subset(becal_completo, tipoestudio == 'NA') # elimina los registros "NA" !(is.na(tipoestudio))
...
#edad
becal_completo$edad = as.numeric(becal_completo$edad)
hist(becal_completo$edad, main=paste("Distribución de becarios por edad (n=",nrow(becal_completo),")"), ylab="Frecuencia", xlab="Edad", col = "red", xlim = c(20, 50))
